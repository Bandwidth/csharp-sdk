// <copyright file="NumberLookupController.cs" company="APIMatic">
...
namespace Bandwidth.Standard.PhoneNumberLookup.Controllers
{
    ...
    /// </summary>
    public class NumberLookupController : BaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberLookupController"/> class.
        /// </summary>
        /// <param name="config"> config instance. </param>
        /// <param name="httpClient"> httpClient. </param>
        /// <param name="authManagers"> authManager. </param>
        /// <param name="httpCallBack"> httpCallBack. </param>
        internal NumberLookupController(IConfiguration config, IHttpClient httpClient, IDictionary<string, IAuthManager> authManagers, HttpCallBack httpCallBack = null)
