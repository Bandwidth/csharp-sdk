...
namespace Bandwidth.Standard.TwoFactorAuth.Controllers
{
    ...
    public class MFAController : BaseController
    {
                ...
                CancellationToken cancellationToken = default)
        {
            ...
            string baseUri = this.Config.GetBaseUri(Server.TwoFactorAuthDefault);
            ...
            httpRequest = await this.AuthManagers["twoFactorAuth"].ApplyAsync(httpRequest).ConfigureAwait(false);
