...
namespace Bandwidth.Standard.WebRtc.Controllers
{
    ...
    public class APIController : BaseController
    {
        ...
        public void RemoveParticipantFromSession(
                ...
                string sessionId)
        {
            Task t = this.RemoveParticipantFromSessionAsync(accountId, participantId, sessionId);
            ApiHelper.RunTaskSynchronously(t);
        }
        ...
        public ApiResponse<Models.Subscriptions> GetParticipantSubscriptions(
                ...
                string sessionId)
        {
            Task<ApiResponse<Models.Subscriptions>> t = this.GetParticipantSubscriptionsAsync(accountId, participantId, sessionId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public void UpdateParticipantSubscriptions(
                ...
                Models.Subscriptions body = null)
        {
            Task t = this.UpdateParticipantSubscriptionsAsync(accountId, participantId, sessionId, body);
            ApiHelper.RunTaskSynchronously(t);
        }
