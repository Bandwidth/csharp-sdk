...
namespace Bandwidth.Standard.Voice.Models
{
    ...
    public static class TypeEnumHelper
    {
        ...
        private static List<string> stringValues = new List<string> { "validation", "authentication-error", "authorization-error", "internal-error", "error", "rate-limit-exceeded", "system-overloaded" };
        ...
        public static string ToValue(TypeEnum enumValue)
        {
            switch(enumValue)
            {
                ...
                case TypeEnum.Validation:
                case TypeEnum.Authenticationerror:
                case TypeEnum.Authorizationerror:
                case TypeEnum.Internalerror:
                case TypeEnum.Error:
                case TypeEnum.Ratelimitexceeded:
                case TypeEnum.Systemoverloaded:
