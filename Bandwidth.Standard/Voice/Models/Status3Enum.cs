    ...
    public static class Status3EnumHelper
    {
        ...
        public static string ToValue(Status3Enum enumValue)
        {
            switch(enumValue)
            {
                ...
                case Status3Enum.None:
                case Status3Enum.Processing:
                case Status3Enum.Available:
                case Status3Enum.Error:
                case Status3Enum.Timeout:
                case Status3Enum.Filesizetoobig:
                case Status3Enum.Filesizetoosmall:
        ...
        public static Status3Enum ParseString(string value)
        {
            ...
            if(index < 0)
                throw new InvalidCastException(string.Format("Unable to cast value: {0} to type Status3Enum", value));
