...
namespace Bandwidth.StandardTests.Mfa
{
    public class CreateVoiceMultiFactorTests
    {
        ...
        public async Task CreateVoiceMultiFactorReturnsOk()
        {
            ...
            var response = await _client.TwoFactorAuth.MFAController.CreateVoiceTwoFactorAsync(accountId, request);
        ...
        public async Task CreateVoiceMultiFactorInvalidToPhoneNumberThrows()
        {
            ...
            var ex = await Assert.ThrowsAsync<ErrorWithRequestException>(() => _client.TwoFactorAuth.MFAController.CreateVoiceTwoFactorAsync(accountId, request));
