...
${nuget_cmd} install src/Bandwidth.Standard/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Bandwidth.Standard.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Bandwidth.Standard.dll \
-recurse:'src/Bandwidth.Standard/*.cs' \
-doc:bin/Bandwidth.Standard.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Bandwidth.Standard.dll was created successfully"
fi
