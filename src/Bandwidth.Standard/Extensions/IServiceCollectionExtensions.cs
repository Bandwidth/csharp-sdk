...
namespace Bandwidth.Standard.Extensions
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddBandwidth(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new HostConfiguration(services);
            options(config);
            AddBandwidth(services, config);
        }

        internal static void AddBandwidth(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddBandwidthHttpClients();
