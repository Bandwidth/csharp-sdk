...
namespace Bandwidth.Standard.Api
{
    ...
    public interface IStatisticsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AccountStatistics> GetStatisticsAsync(string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AccountStatistics>> GetStatisticsWithHttpInfoAsync(string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class StatisticsApi : IStatisticsApi
    {
        ...
        /// <returns></returns>
        public StatisticsApi(Bandwidth.Standard.Client.Configuration configuration)
        {
        ...
        public StatisticsApi(Bandwidth.Standard.Client.ISynchronousClient client, Bandwidth.Standard.Client.IAsynchronousClient asyncClient, Bandwidth.Standard.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Bandwidth.Standard.Client.ApiResponse<AccountStatistics> localVarResponse = GetStatisticsWithHttpInfo(accountId);
        ...
        public Bandwidth.Standard.Client.ApiResponse<AccountStatistics> GetStatisticsWithHttpInfo(string accountId, int operationIndex = 0)
        {
            ...
            if (accountId == null)
            {
                throw new Bandwidth.Standard.Client.ApiException(400, "Missing required parameter 'accountId' when calling StatisticsApi->GetStatistics");
            }
            ...
            localVarRequestOptions.Operation = "StatisticsApi.GetStatistics";
            ...
            var localVarResponse = this.Client.Get<AccountStatistics>("/accounts/{accountId}/statistics", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AccountStatistics</returns>
        public async System.Threading.Tasks.Task<AccountStatistics> GetStatisticsAsync(string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Bandwidth.Standard.Client.ApiResponse<AccountStatistics> localVarResponse = await GetStatisticsWithHttpInfoAsync(accountId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountStatistics)</returns>
        public async System.Threading.Tasks.Task<Bandwidth.Standard.Client.ApiResponse<AccountStatistics>> GetStatisticsWithHttpInfoAsync(string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AccountStatistics>("/accounts/{accountId}/statistics", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
