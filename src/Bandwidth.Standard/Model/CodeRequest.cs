...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class CodeRequest :  IEquatable<CodeRequest>, IValidatableObject
    {
        ...
        public CodeRequest(string to = default(string), string from = default(string), string applicationId = default(string), string scope = default(string), string message = default(string), int digits = default(int))
        {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for CodeRequest and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for CodeRequest and cannot be null");
            }
            else
            {
                this.From = from;
            ...
            {
                throw new InvalidDataException("applicationId is a required property for CodeRequest and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for CodeRequest and cannot be null");
            }
            else
            {
            ...
            if (digits == null)
            {
                throw new InvalidDataException("digits is a required property for CodeRequest and cannot be null");
            }
            else
            {
                this.Digits = digits;
