...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class VerificationDenialWebhook : IValidatableObject
    {
        ...
        public VerificationDenialWebhook(string accountId = default(string), List<AdditionalDenialReason> additionalDenialReasons = default(List<AdditionalDenialReason>), string declineReasonDescription = default(string), int denialStatusCode = default(int), string internalTicketNumber = default(string), string phoneNumber = default(string), bool resubmitAllowed = default(bool), string status = @"UNVERIFIED", bool blocked = default(bool), string blockedReason = default(string))
        {
