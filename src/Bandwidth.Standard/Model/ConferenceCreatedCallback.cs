...
namespace Bandwidth.Standard.Model
{
    ...
    /// </summary>
    [DataContract(Name = "conferenceCreatedCallback")]
    public partial class ConferenceCreatedCallback : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConferenceCreatedCallback" /> class.
        /// </summary>
        ...
        public ConferenceCreatedCallback(string eventType = default(string), DateTime eventTime = default(DateTime), string conferenceId = default(string), string name = default(string), string tag = default(string))
        {
