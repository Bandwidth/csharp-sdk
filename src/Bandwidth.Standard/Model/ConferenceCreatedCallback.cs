...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ConferenceCreatedCallback : IEquatable<ConferenceCreatedCallback>, IValidatableObject
    {
        ...
        public ConferenceCreatedCallback(string eventType = default(string), string eventTime = default(string), string conferenceId = default(string), string name = default(string), string tag = default(string))
        {
