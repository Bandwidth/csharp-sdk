...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ConferenceMemberJoinCallback : IValidatableObject
    {
        /// <summary>
        ...
        public ConferenceMemberJoinCallback(string eventType = default(string), DateTime eventTime = default(DateTime), string conferenceId = default(string), string name = default(string), string from = default(string), string to = default(string), string callId = default(string), string tag = default(string))
        {
