...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class MessageSendingCallback :  IEquatable<MessageSendingCallback>, IValidatableObject
    {
        ...
        public MessageSendingCallback(DateTime time = default(DateTime), string type = default(string), string to = default(string), string description = default(string), MessageSendingCallbackMessage message = default(MessageSendingCallbackMessage))
        {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for MessageSendingCallback and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for MessageSendingCallback and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for MessageSendingCallback and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for MessageSendingCallback and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for MessageSendingCallback and cannot be null");
            }
            else
            {
