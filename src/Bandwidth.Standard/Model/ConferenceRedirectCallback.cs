...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ConferenceRedirectCallback : IValidatableObject
    {
        ...
        public ConferenceRedirectCallback(string eventType = default(string), DateTime eventTime = default(DateTime), string conferenceId = default(string), string name = default(string), string tag = default(string))
        {
