...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class MessageDeliveredCallbackMessage :  IEquatable<MessageDeliveredCallbackMessage>, IValidatableObject
    {
        ...
        public MessageDeliveredCallbackMessage(string id = default(string), string owner = default(string), string applicationId = default(string), DateTime time = default(DateTime), int segmentCount = default(int), MessageDirectionEnum direction = default(MessageDirectionEnum), List<string> to = default(List<string>), string from = default(string), string text = default(string), string tag = default(string), List<string> media = default(List<string>), PriorityEnum? priority = default(PriorityEnum?))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (owner == null)
            {
                throw new InvalidDataException("owner is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
                this.Owner = owner;
            ...
            {
                throw new InvalidDataException("applicationId is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            {
                throw new InvalidDataException("segmentCount is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
            ...
            if (direction == null)
            {
                throw new InvalidDataException("direction is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
                this.From = from;
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
                this.Text = text;
            ...
            if (tag == null)
            {
                throw new InvalidDataException("tag is a required property for MessageDeliveredCallbackMessage and cannot be null");
            }
            else
            {
                this.Tag = tag;
