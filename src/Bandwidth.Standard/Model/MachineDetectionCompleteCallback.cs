...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class MachineDetectionCompleteCallback : IEquatable<MachineDetectionCompleteCallback>, IValidatableObject
    {
        ...
        public MachineDetectionCompleteCallback(string eventType = default(string), string eventTime = default(string), string accountId = default(string), string applicationId = default(string), string from = default(string), string to = default(string), CallDirectionEnum? direction = default(CallDirectionEnum?), string callId = default(string), string callUrl = default(string), DateTime? enqueuedTime = default(DateTime?), DateTime startTime = default(DateTime), DateTime? answerTime = default(DateTime?), string tag = default(string), string machineDetectionResult = default(string))
        {
