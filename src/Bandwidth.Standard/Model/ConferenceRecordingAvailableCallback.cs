...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ConferenceRecordingAvailableCallback : IEquatable<ConferenceRecordingAvailableCallback>, IValidatableObject
    {
        ...
        public ConferenceRecordingAvailableCallback(string eventType = default(string), string eventTime = default(string), string conferenceId = default(string), string name = default(string), string accountId = default(string), string recordingId = default(string), int channels = default(int), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), string duration = default(string), FileFormatEnum? fileFormat = default(FileFormatEnum?), string mediaUrl = default(string), string tag = default(string), string status = default(string))
        {
