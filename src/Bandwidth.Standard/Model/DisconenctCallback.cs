...
namespace Bandwidth.Standard.Model
{
    ...
    /// </summary>
    [DataContract(Name = "disconenctCallback")]
    public partial class DisconenctCallback : IEquatable<DisconenctCallback>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisconenctCallback" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisconenctCallback {\n");
        ...
        {
            return this.Equals(input as DisconenctCallback);
        }

        /// <summary>
        /// Returns true if DisconenctCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of DisconenctCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisconenctCallback input)
        {
            if (input == null)
            {
                return false;
