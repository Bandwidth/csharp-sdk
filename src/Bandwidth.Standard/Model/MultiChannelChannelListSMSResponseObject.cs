...
namespace Bandwidth.Standard.Model
{
    ...
    /// </summary>
    [DataContract(Name = "multiChannelChannelListSMSResponseObject")]
    public partial class MultiChannelChannelListSMSResponseObject : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiChannelChannelListSMSResponseObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiChannelChannelListSMSResponseObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiChannelChannelListSMSResponseObject" /> class.
        /// </summary>
        ...
        public MultiChannelChannelListSMSResponseObject(string from = default(string), string applicationId = default(string), MultiChannelMessageChannelEnum channel = default(MultiChannelMessageChannelEnum), SmsMessageContent content = default(SmsMessageContent), string owner = default(string))
        {
            // to ensure "from" is required (not null)
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for MultiChannelChannelListSMSResponseObject and cannot be null");
            }
            this.From = from;
            // to ensure "applicationId" is required (not null)
            if (applicationId == null)
            {
                throw new ArgumentNullException("applicationId is a required property for MultiChannelChannelListSMSResponseObject and cannot be null");
            }
            ...
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for MultiChannelChannelListSMSResponseObject and cannot be null");
            }
            this.Content = content;
            // to ensure "owner" is required (not null)
            if (owner == null)
            {
                throw new ArgumentNullException("owner is a required property for MultiChannelChannelListSMSResponseObject and cannot be null");
            }
            this.Owner = owner;
        }
