...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class RecordingAvailableCallback : IEquatable<RecordingAvailableCallback>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as RecordingAvailableCallback);
        }

        /// <summary>
        /// Returns true if RecordingAvailableCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordingAvailableCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingAvailableCallback input)
        {
            if (input == null)
            {
                return false;
