...
namespace Bandwidth.Standard.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatherCallback")]
    public partial class GatherCallback : IEquatable<GatherCallback>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GatherCallback" /> class.
        /// </summary>
        ...
        /// <param name="digits">(optional) The digits, letters, and/or symbols entered by the user. The string is empty if a timeout occurred before any buttons were pressed..</param>
        ...
        /// <param name="terminatingDigit">(optional) The digit the user pressed to end the gather. Empty string value if no terminating digit was pressed..</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TerminatingDigit: ").Append(TerminatingDigit).Append("\n");
        ...
        {
            return this.Equals(input as GatherCallback);
        }

        /// <summary>
        /// Returns true if GatherCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of GatherCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatherCallback input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TerminatingDigit == input.TerminatingDigit ||
                    (this.TerminatingDigit != null &&
                    this.TerminatingDigit.Equals(input.TerminatingDigit))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.TerminatingDigit.GetHashCode();
                }
