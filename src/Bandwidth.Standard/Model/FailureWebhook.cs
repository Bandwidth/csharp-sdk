...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class FailureWebhook : IValidatableObject
    {
        ...
        public FailureWebhook(string accountId = default(string), string phoneNumber = default(string), string errorCode = default(string), string errorMessage = default(string), List<string> errors = default(List<string>), string internalTicketNumber = default(string))
        {
