...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class VerifyCodeRequest :  IEquatable<VerifyCodeRequest>, IValidatableObject
    {
        ...
        public VerifyCodeRequest(string to = default(string), string scope = default(string), decimal expirationTimeInMinutes = default(decimal), string code = default(string))
        {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for VerifyCodeRequest and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            // to ensure "expirationTimeInMinutes" is required (not null)
            if (expirationTimeInMinutes == null)
            {
                throw new InvalidDataException("expirationTimeInMinutes is a required property for VerifyCodeRequest and cannot be null");
            }
            else
            {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for VerifyCodeRequest and cannot be null");
            }
            else
            {
                this.Code = code;
        ...
        [DataMember(Name="expirationTimeInMinutes", EmitDefaultValue=true)]
