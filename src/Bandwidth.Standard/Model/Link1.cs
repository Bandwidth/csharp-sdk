...
namespace Bandwidth.Standard.Model
{
    ...
    /// Link1
    /// </summary>
    [DataContract(Name = "link1")]
    public partial class Link1 : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Link1" /> class.
        /// </summary>
        ...
        public Link1(string href = default(string), string rel = default(string), MethodEnum? method = default(MethodEnum?))
        {
            this.Href = href;
            this.Rel = rel;
            this.Method = method;
