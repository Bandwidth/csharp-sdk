...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ConferenceMemberExitCallback : IEquatable<ConferenceMemberExitCallback>, IValidatableObject
    {
        ...
        public ConferenceMemberExitCallback(string eventType = default(string), string eventTime = default(string), string conferenceId = default(string), string name = default(string), string from = default(string), string to = default(string), string callId = default(string), string tag = default(string))
        {
