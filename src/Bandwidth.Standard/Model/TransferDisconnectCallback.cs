...
namespace Bandwidth.Standard.Model
{
    ...
    /// </summary>
    [DataContract(Name = "transferDisconnectCallback")]
    public partial class TransferDisconnectCallback : IEquatable<TransferDisconnectCallback>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferDisconnectCallback" /> class.
        /// </summary>
        ...
        public TransferDisconnectCallback(string eventType = default(string), string eventTime = default(string), string accountId = default(string), string applicationId = default(string), string from = default(string), string to = default(string), CallDirectionEnum? direction = default(CallDirectionEnum?), string callId = default(string), string callUrl = default(string), string parentCallId = default(string), DateTime? enqueuedTime = default(DateTime?), DateTime startTime = default(DateTime), DateTime? answerTime = default(DateTime?), DateTime endTime = default(DateTime), string tag = default(string), string transferCallerId = default(string), string transferTo = default(string), string cause = default(string), string errorMessage = default(string), string errorId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferDisconnectCallback {\n");
        ...
        {
            return this.Equals(input as TransferDisconnectCallback);
        }

        /// <summary>
        /// Returns true if TransferDisconnectCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferDisconnectCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferDisconnectCallback input)
        {
            if (input == null)
            {
                return false;
