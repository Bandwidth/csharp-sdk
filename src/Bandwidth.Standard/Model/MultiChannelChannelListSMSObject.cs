...
namespace Bandwidth.Standard.Model
{
    ...
    /// </summary>
    [DataContract(Name = "multiChannelChannelListSMSObject")]
    public partial class MultiChannelChannelListSMSObject : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiChannelChannelListSMSObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiChannelChannelListSMSObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiChannelChannelListSMSObject" /> class.
        /// </summary>
        ...
        public MultiChannelChannelListSMSObject(string from = default(string), string applicationId = default(string), MultiChannelMessageChannelEnum channel = default(MultiChannelMessageChannelEnum), SmsMessageContent content = default(SmsMessageContent))
        {
            // to ensure "from" is required (not null)
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for MultiChannelChannelListSMSObject and cannot be null");
            }
            this.From = from;
            // to ensure "applicationId" is required (not null)
            if (applicationId == null)
            {
                throw new ArgumentNullException("applicationId is a required property for MultiChannelChannelListSMSObject and cannot be null");
            }
            ...
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for MultiChannelChannelListSMSObject and cannot be null");
            }
