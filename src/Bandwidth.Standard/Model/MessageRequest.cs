...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class MessageRequest :  IEquatable<MessageRequest>, IValidatableObject
    {
        ...
        public MessageRequest(string applicationId = default(string), List<string> to = default(List<string>), string from = default(string), string text = default(string), List<string> media = default(List<string>), string tag = default(string), PriorityEnum? priority = default(PriorityEnum?), DateTime expiration = default(DateTime))
        {
            ...
            {
                throw new InvalidDataException("applicationId is a required property for MessageRequest and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for MessageRequest and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for MessageRequest and cannot be null");
            }
            else
            {
                this.From = from;
