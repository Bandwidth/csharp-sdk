...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ConferenceCompletedCallback : IEquatable<ConferenceCompletedCallback>, IValidatableObject
    {
        ...
        public ConferenceCompletedCallback(string eventType = default(string), string eventTime = default(string), string conferenceId = default(string), string name = default(string), string tag = default(string))
        {
