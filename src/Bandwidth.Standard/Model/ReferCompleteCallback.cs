...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ReferCompleteCallback : IValidatableObject
    {
        ...
        /// <param name="referCallStatus">referCallStatus.</param>
        /// <param name="referSipResponseCode">(optional) The SIP response code returned for the REFER request itself (e.g. 202, 405, 603). Present when a SIP response was received for the REFER..</param>
        /// <param name="notifySipResponseCode">(optional) The final SIP response code reported via NOTIFY (message/sipfrag body). Present only when the caller&#39;s endpoint sent a final NOTIFY (e.g. 200, 404, 486, 503). Not present on NOTIFY timeout or when the REFER was rejected before a subscription was established..</param>
        ...
        /// </summary>
        /// <value>(optional) The SIP response code returned for the REFER request itself (e.g. 202, 405, 603). Present when a SIP response was received for the REFER.</value>
        /// <example>202</example>
        [DataMember(Name = "referSipResponseCode", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>(optional) The final SIP response code reported via NOTIFY (message/sipfrag body). Present only when the caller&#39;s endpoint sent a final NOTIFY (e.g. 200, 404, 486, 503). Not present on NOTIFY timeout or when the REFER was rejected before a subscription was established.</value>
        /// <example>200</example>
        [DataMember(Name = "notifySipResponseCode", EmitDefaultValue = false)]
