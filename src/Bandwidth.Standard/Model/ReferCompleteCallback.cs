...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ReferCompleteCallback : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="eventType">The event type, value is referComplete..</param>
        ...
        /// <summary>
        /// The event type, value is referComplete.
        /// </summary>
        /// <value>The event type, value is referComplete.</value>
        /// <example>referComplete</example>
        ...
        /// </summary>
        /// <value>The outcome of the REFER operation. Either &quot;success&quot; or &quot;failure&quot;.</value>
        /// <example>success</example>
        [DataMember(Name = "referCallStatus", EmitDefaultValue = false)]
        public string ReferCallStatus { get; set; }

        /// <summary>
        /// Integer (optional). The SIP response code returned for the REFER request itself (e.g. 202, 405, 603).
        /// </summary>
        /// <value>Integer (optional). The SIP response code returned for the REFER request itself (e.g. 202, 405, 603).</value>
        /// <example>202</example>
        [DataMember(Name = "referSipResponseCode", EmitDefaultValue = true)]
        public int? ReferSipResponseCode { get; set; }

        /// <summary>
        /// Integer (optional). The final SIP response code reported via NOTIFY. Present only when the caller&#39;s endpoint sent a final NOTIFY.
        /// </summary>
        /// <value>Integer (optional). The final SIP response code reported via NOTIFY. Present only when the caller&#39;s endpoint sent a final NOTIFY.</value>
        /// <example>200</example>
