...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class ReferCompleteCallback : IValidatableObject
    {
        ...
        /// <param name="sipResponseCode">The SIP response code from the REFER request, indicating the outcome of the operation (e.g., 200 for success, 404 for not found)..</param>
        ...
        /// <summary>
        /// The SIP response code from the REFER request, indicating the outcome of the operation (e.g., 200 for success, 404 for not found).
        /// </summary>
