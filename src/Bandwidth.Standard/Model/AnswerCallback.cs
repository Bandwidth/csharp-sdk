...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class AnswerCallback : IEquatable<AnswerCallback>, IValidatableObject
    {
        ...
        /// <param name="machineDetectionResult">(optional) if machine detection was requested in sync mode, the result will be specified here. Possible values are the same as the async counterpart: Machine Detection Complete.</param>
        public AnswerCallback(string eventType = default(string), string eventTime = default(string), string accountId = default(string), string applicationId = default(string), string from = default(string), string to = default(string), CallDirectionEnum? direction = default(CallDirectionEnum?), string callId = default(string), string callUrl = default(string), DateTime? enqueuedTime = default(DateTime?), DateTime startTime = default(DateTime), DateTime? answerTime = default(DateTime?), string tag = default(string), string machineDetectionResult = default(string))
        {
        ...
        /// </summary>
        /// <value>(optional) if machine detection was requested in sync mode, the result will be specified here. Possible values are the same as the async counterpart: Machine Detection Complete</value>
