...
namespace Bandwidth.Standard.Model
{
    ...
    public partial class InitiateCallback : IEquatable<InitiateCallback>, IValidatableObject
    {
        ...
        public InitiateCallback(string eventType = default(string), string eventTime = default(string), string accountId = default(string), string applicationId = default(string), string from = default(string), string to = default(string), CallDirectionEnum? direction = default(CallDirectionEnum?), string callId = default(string), string callUrl = default(string), DateTime startTime = default(DateTime), Diversion diversion = default(Diversion), StirShaken stirShaken = default(StirShaken))
        {
