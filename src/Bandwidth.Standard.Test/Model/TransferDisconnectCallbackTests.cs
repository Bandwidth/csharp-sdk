...
{
    /// <summary>
    ///  Class for testing TransferDisconnectCallback
    /// </summary>
    public class TransferDisconnectCallbackTests : IDisposable
    {
        private TransferDisconnectCallback instance;

        public TransferDisconnectCallbackTests()
        {
            instance = new TransferDisconnectCallback();
        }
        ...
        /// <summary>
        /// Test an instance of TransferDisconnectCallback
        /// </summary>
        [Fact]
        public void TransferDisconnectCallbackInstanceTest()
        {
            Assert.IsType<TransferDisconnectCallback>(instance);
        }
        ...
        {
            instance.EventType = "transferDisconnect";
            Assert.IsType<string>(instance.EventType);
            Assert.Equal("transferDisconnect", instance.EventType);
        }
        /// <summary>
        ...
        {
            instance.ErrorMessage = "Call c-1234 is already bridged with another call";
            Assert.IsType<string>(instance.ErrorMessage);
            Assert.Equal("Call c-1234 is already bridged with another call", instance.ErrorMessage);
        }
        /// <summary>
