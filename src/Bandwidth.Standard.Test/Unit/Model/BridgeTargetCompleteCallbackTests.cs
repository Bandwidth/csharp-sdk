...
namespace Bandwidth.Standard.Test.Unit.Model
{
    ...
    public class BridgeTargetCompleteCallbackTests : IDisposable
    {
        ...
        {
            instance.EventType = "bridgeTargetComplete";
            Assert.IsType<string>(instance.EventType);
            Assert.Equal("bridgeTargetComplete", instance.EventType);
        }
        /// <summary>
        ...
        {
            instance.EventTime = new DateTime(2000, 1, 1, 0, 0, 0, DateTimeKind.Utc);
            Assert.IsType<DateTime>(instance.EventTime);
            Assert.Equal(new DateTime(2000, 1, 1, 0, 0, 0, DateTimeKind.Utc), instance.EventTime);
        }
        /// <summary>
